...
class MedicalCenterItem extends Component {
  render() {
    ...
    return (
      <TouchableOpacity
        onPress={() =>
          this.props.navigateToPage("MedicalCenterDetail", { idDetail })
        }
        ...
        <View style={styles.body}>
          <View style={styles.header}>
            <View style={styles.nameWrap}>
              ...
              {item.owned &&
                <Text style={styles.type}>{strings('component_search.medical_center')} {item.owned.toUpperCase()}</Text>
              }
            </View>
