...
class MedicalCenterDetailScreen extends Component {
  constructor() {
    super();
    // this.state = {
    //   loading: true,
  ...
  render() {
    ...
    const subtitle = `${strings('medical_center_detail.medical_center')} ${details.owned}`;
    return (
      <View style={styles.container}>
        <AppHeader />
        <Toolbar
          title={strings('medical_center_detail.info')}
        ...
        {!loading && (
          <ScrollView bounces={false} contentContainerStyle={{padding: sizeWidth(2)}}>
            ...
            <View style={styles.bottom}>
              ...
              <Button style={styles.book} text={strings('medical_center_detail.book_medical')} onPress={() => this.props.openBookingModal(details.id)} />
            </View>
