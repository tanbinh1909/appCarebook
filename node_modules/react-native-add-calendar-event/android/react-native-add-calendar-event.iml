...
<module external.linked.project.id=":react-native-add-calendar-event" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../example/EventDemo/android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
